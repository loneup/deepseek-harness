...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  NexusSessionId: 'Nexus port session identity is owned by packages/host/nexus-dsh-compat/README.md',
  NexusRequestId: 'Nexus port request identity is owned by packages/host/nexus-dsh-compat/README.md',
  NexusSessionListRequest: 'Nexus port wire type is owned by packages/host/nexus-dsh-compat/README.md',
  NexusSessionListValue: 'Nexus port wire type is owned by packages/host/nexus-dsh-compat/README.md',
  NexusCreateSessionRequest: 'Nexus port wire type is owned by packages/host/nexus-dsh-compat/README.md',
  NexusCreateSessionValue: 'Nexus port wire type is owned by packages/host/nexus-dsh-compat/README.md',
  NexusModelCatalog: 'Nexus port wire type is owned by packages/host/nexus-dsh-compat/README.md',
  NexusSelectModelRequest: 'Nexus port wire type is owned by packages/host/nexus-dsh-compat/README.md',
  NexusSelectModelValue: 'Nexus port wire type is owned by packages/host/nexus-dsh-compat/README.md',
  NexusPromptRequest: 'Nexus port wire type is owned by packages/host/nexus-dsh-compat/README.md',
  NexusPromptValue: 'Nexus port wire type is owned by packages/host/nexus-dsh-compat/README.md',
  NexusCancelValue: 'Nexus port wire type is owned by packages/host/nexus-dsh-compat/README.md',
  NexusHistoryRequest: 'Nexus port wire type is owned by packages/host/nexus-dsh-compat/README.md',
  NexusHistoryPage: 'Nexus port wire type is owned by packages/host/nexus-dsh-compat/README.md',
  NexusSubagentCatalog: 'Nexus port wire type is owned by packages/host/nexus-dsh-compat/README.md',
  NexusSubagentPromptRequest: 'Nexus port wire type is owned by packages/host/nexus-dsh-compat/README.md',
  NexusSubagentPromptReceipt: 'Nexus port wire type is owned by packages/host/nexus-dsh-compat/README.md',
  NexusSubagentInterruptRequest: 'Nexus port wire type is owned by packages/host/nexus-dsh-compat/README.md',
  NexusSubagentInterruptReceipt: 'Nexus port wire type is owned by packages/host/nexus-dsh-compat/README.md',
