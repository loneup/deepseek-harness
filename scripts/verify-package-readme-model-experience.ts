...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-settings-nexus': { kind: 'none', reason: 'Browser-side Nexus administration UI; registers nothing model-facing.' },
  ...
  'packages/host/nexus-bridge': { kind: 'none', reason: 'The Host route plugin exposes transport health and registers nothing model-facing.' },
  'packages/host/nexus-dsh-compat': { kind: 'none', reason: 'The in-process port seam between the Nexus Bridge and the harness registers nothing model-facing.' },
